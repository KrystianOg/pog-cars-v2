import { Body, Link, Container, Text, Head, Heading, Html, Button, Preview, Section, Img, Hr } from "@react-email/components";
...
export const InviteUser = ({agency, user, invitedBy, inviteLink}: InviteUserProps) => {
  return (
    <Html>
      <Head/>
...
InviteUser.PreviewProps = {
  inviteLink: 'http://localhost:3000/agencies/invite?u=cfd25111-9b9d-4e1c-95dd-81a0c1e502b3',
  agency: {
    name: 'pOg',
  },
  user: {
